...
public class TorqueRecipeProvider extends CustomRecipeProvider {
    ...
    public TorqueRecipeProvider(HolderLookup.Provider provider, RecipeOutput output) {
    ...
    protected void buildRecipes() {
        var itemReg = this.provider.lookupOrThrow(Registries.ITEM);
        setRegistry(itemReg);
        buildVanillaRecipes(recipeOutput);

        buildGrinderRecipes(recipeOutput);

        registerPackageRecipe(TorqueItems.HSLA_INGOT.get(), TorqueItems.HSLA_BLOCK_ITEM.get());
        registerPackageRecipe(TorqueItems.CAST_IRON_INGOT.get(), TorqueItems.CAST_IRON_BLOCK_ITEM.get());

        registerMaterialRecipes(recipeOutput);
        registerBlockRecipes(recipeOutput);
        registerComponents(recipeOutput);
        registerGears(recipeOutput);
...
//        grinding(Tags.Items.SEEDS, TorqueItems.CRUSHED_SEEDS.get(), new FluidStack(TorqueFluids.SOURCE_LUBRICANT.get(), 100), output);
    ...
    private void registerGears(RecipeOutput output) {
        shapeless(RecipeCategory.MISC, TorqueItems.HSLA_SHAFT_ITEM.get())
        ...
        shaped(RecipeCategory.MISC, TorqueBlocks.HSLA_THREE_WAY.get())
                .pattern(" R ")
                .pattern("RRR")
                .pattern(" C ")
        ...
        shaped(RecipeCategory.MISC, TorqueBlocks.HSLA_BEVEL_GEARS.get())
                .pattern(" R ")
                .pattern("RC ")
                .define('R', TorqueItems.HSLA_GEAR.get())
                .define('C', TorqueItems.HSLA_CASING.get())
        ...
        shaped(RecipeCategory.MISC, TorqueBlocks.HSLA_GEARBOX1_2.get())
                .pattern(" G ")
                .pattern(" C ")
        ...
        shaped(RecipeCategory.MISC, TorqueBlocks.HSLA_GEARBOX1_4.get())
                .pattern(" G ")
                .pattern(" C ")
    ...
    private void registerMachines(RecipeOutput output) {
        shaped(RecipeCategory.MISC, TorqueItems.GRINDER_ITEM.get())
                .pattern("STS")
                .pattern(" C ")
                ...
                .unlockedBy(getHasName(TorqueItems.HSLA_CASING.get()), has(TorqueItems.HSLA_CASING.get()))
                .save(output);
        shaped(RecipeCategory.MISC, TorqueItems.COOLING_RADIATOR_ITEM.get())
                .pattern("PPP")
                .pattern("PPP")
                .pattern("S S")
                ...
                .save(output);
        shaped(RecipeCategory.MISC, TorqueItems.ROTARY_WRENCH.get())
                .pattern("  I")
                .pattern(" P ")
                .pattern("P  ")
                ...
                .save(output);
//        shaped(RecipeCategory.MISC, TorqueItems.FLUID_TANK_ITEM.get())
//                .pattern("LPL")
//                .pattern("LTL")
//                .pattern("LPL")
//                .define('L', TorqueItems.HSLA_PLATE.get())
//                .define('T', TorqueItems.HSLA_TANK.get())
//                .define('P', TorqueItems.HSLA_INGOT.get())
//                .unlockedBy(getHasName(TorqueItems.HSLA_PLATE.get()), has(TorqueItems.HSLA_PLATE.get()))
//                .unlockedBy(getHasName(TorqueItems.HSLA_TANK.get()), has(TorqueItems.HSLA_TANK.get()))
//                .unlockedBy(getHasName(TorqueItems.HSLA_INGOT.get()), has(TorqueItems.HSLA_INGOT.get()))
//                .save(output);
        shaped(RecipeCategory.MISC, TorqueBlocks.MECHANICAL_FAN.get())
                .pattern("II ")
                .pattern("SSG")
                .pattern("II ")
                .define('I', TorqueItems.HSLA_INGOT.get())
                ...
                .unlockedBy(getHasName(TorqueItems.HSLA_INGOT.get()), has(TorqueItems.HSLA_INGOT.get()))
                .save(output);
        shaped(RecipeCategory.MISC, TorqueBlocks.SPRINKLER.get())
                .pattern(" P ")
                .pattern("RPR")
                .pattern(" G ")
                .define('P', TorqueItems.HSLA_INGOT.get())
        ...
        shaped(RecipeCategory.MISC, TorqueBlocks.PUMP.get())
                .pattern("IPI")
                .pattern("GCS")
                .pattern("IPI")
                .define('I', TorqueItems.HSLA_INGOT.get())
        ...
        shaped(RecipeCategory.MISC, TorqueBlocks.STEAM_ENGINE.get())
                .pattern("G G")
                .pattern("PTP")
                .pattern("IXI")
                .define('I', TorqueItems.HSLA_INGOT.get())
                ...
                .define('G', TorqueItems.HSLA_GEAR.get())
                .define('X', TorqueItems.HSLA_INGOT.get())
                .unlockedBy(getHasName(TorqueItems.HSLA_INGOT.get()), has(TorqueItems.HSLA_INGOT.get()))
                .unlockedBy(getHasName(TorqueItems.HSLA_INGOT.get()), has(TorqueItems.HSLA_INGOT.get()))
                .unlockedBy(getHasName(TorqueItems.HSLA_TANK.get()), has(TorqueItems.HSLA_TANK.get()))
        ...
        shaped(RecipeCategory.MISC, TorqueBlocks.VACUUM.get())
                .pattern("PGP")
                .pattern("GGG")
                .pattern("PPP")
                .define('P', TorqueItems.HSLA_PLATE.get())
    ...
    private void registerBlockRecipes(RecipeOutput output) {
        shaped(RecipeCategory.MISC, TorqueBlocks.ALLOY_FURNACE.get())
                .pattern("SSS")
                .pattern("SBS")
                .pattern("SSS")
        ...
        shaped(RecipeCategory.MISC, TorqueItems.ROTARY_MONITOR.get())
                .pattern("III")
                .pattern("ICI")
                .pattern("IGI")
                //Change to HSLA ?
    ...
    private void registerComponents(RecipeOutput output) {
        shaped(RecipeCategory.MISC, TorqueItems.CIRCUIT_MODULE.get())
                .pattern("IGI")
                .pattern("SRS")
                .pattern("ISI")
        ...
        shaped(RecipeCategory.MISC, TorqueItems.HSLA_CASING.get())
                .pattern("I I")
                .pattern("I I")
                .pattern("III")
                .define('I', TorqueItems.HSLA_INGOT.get())
        ...
        shaped(RecipeCategory.MISC, TorqueItems.HSLA_STEEL_SHAFT.get())
                .pattern("  I")
                .pattern(" I ")
                .pattern("I  ")
        ...
        shaped(RecipeCategory.MISC, TorqueItems.HSLA_PISTON.get())
                .pattern(" P ")
                .pattern(" R ")
                .pattern(" G ")
                .define('P', TorqueItems.HSLA_PLATE.get())
        ...
        shaped(RecipeCategory.MISC, TorqueItems.HSLA_TANK.get())
                .pattern("I I")
                .pattern("I I")
                .pattern("III")
        ...
        shaped(RecipeCategory.MISC, TorqueItems.HSLA_PLATE.get())
                .pattern("III")
                .define('I', TorqueItems.HSLA_INGOT.get())
                .unlockedBy(getHasName(TorqueItems.HSLA_INGOT.get()), has(TorqueItems.HSLA_INGOT.get()))
                .save(output);

        shaped(RecipeCategory.MISC, TorqueItems.HSLA_GEAR.get())
                .pattern(" S ")
                .pattern("SIS")
                .pattern(" S ")
                .define('I', TorqueItems.HSLA_INGOT.get())
        ...
        shaped(RecipeCategory.MISC, TorqueItems.SHARP_HSLA_GEAR.get())
                .pattern("S S")
                .pattern(" I ")
                .pattern("S S")
                .define('I', TorqueItems.HSLA_INGOT.get())
        ...
        shapeless(RecipeCategory.MISC, TorqueItems.HSLA_ROD.get())
                .requires(TorqueItems.HSLA_INGOT.get(), 2)
                .unlockedBy(getHasName(TorqueItems.HSLA_INGOT.get()), has(TorqueItems.HSLA_INGOT.get()))
                .save(output);

        shapeless(RecipeCategory.MISC, TorqueItems.HSLA_GEARS_2.get())
                .requires(TorqueItems.HSLA_GEAR.get(), 2)
                .unlockedBy(getHasName(TorqueItems.HSLA_GEAR.get()), has(TorqueItems.HSLA_GEAR.get()))
                .save(output);

        shapeless(RecipeCategory.MISC, TorqueItems.HSLA_GEARS_4.get())
        ...
        shapeless(RecipeCategory.MISC, TorqueItems.HSLA_GEARS_8.get())
        ...
        shapeless(RecipeCategory.MISC, TorqueItems.HSLA_GEARS_16.get())
    ...
    private void registerMaterialRecipes(RecipeOutput output) {
        smeltingResultFromBase(TorqueItems.SILICON.get(), TorqueItems.QUARTZ_DUST.get());
    ...
    public static class Runner extends RecipeProvider.Runner {
        ...
        protected @NotNull RecipeProvider createRecipeProvider(HolderLookup.@NotNull Provider provider, @NotNull RecipeOutput output) {
            return new TorqueRecipeProvider(provider, output);
        }

        @Override
        public @NotNull String getName() {
            return TorqueCraft.MODID + ":recipe_provider";
        }
    }
}
