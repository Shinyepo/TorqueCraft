...
public class PipePatterns {
    ...
    public static QuadSetting findPattern(PipeConnection s1, PipeConnection s2, PipeConnection s3, PipeConnection s4) {
        return PATTERNS.get(new Pattern(s1 != PipeConnection.NONE, s2 != PipeConnection.NONE, s3 != PipeConnection.NONE, s4 != PipeConnection.NONE));
    }
