...
public class ThreeWayRenderer implements BlockEntityRenderer<ThreeWayEntity> {
    ...
    @Override
    public void render(ThreeWayEntity blockEntity, float partialTick, PoseStack pose, MultiBufferSource buffer, int packedLight, int packedOverlay, Vec3 pCameraPos) {
