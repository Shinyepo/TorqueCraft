...
public class GearboxRenderer implements BlockEntityRenderer<GearboxEntity> {
    public GearboxRenderer(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(GearboxEntity blockEntity, float partialTick, PoseStack pose, MultiBufferSource buffer, int packedLight, int packedOverlay, Vec3 pCameraPos) {
